...
describe TestimoniosController do
  ...
  let(:valid_attributes) { { "contenido" => "MyText" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved testimonio as @testimonio" do
        ...
        post :create, {:testimonio => { "contenido" => "invalid value" }}, valid_session
        assigns(:testimonio).should be_a_new(Testimonio)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested testimonio" do
        ...
        Testimonio.any_instance.should_receive(:update_attributes).with({ "contenido" => "MyText" })
        put :update, {:id => testimonio.to_param, :testimonio => { "contenido" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the testimonio as @testimonio" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Testimonio.any_instance.stub(:save).and_return(false)
        put :update, {:id => testimonio.to_param, :testimonio => { "contenido" => "invalid value" }}, valid_session
        assigns(:testimonio).should eq(testimonio)
      end
